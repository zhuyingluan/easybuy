...
public class AdminProductCategoryController {
     ...
     * @return
     */
    @RequestMapping(value = "/toAddProductCategory")
     ...
     * @return
     */
    @RequestMapping(value = "/toUpdateProductCategory")
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/queryProductCategoryList")
    public String queryProductCategoryList(HttpServletRequest request, HttpServletResponse response)throws Exception{
    ...
    public String modifyProductCategory(HttpServletRequest request,HttpServletResponse response)throws Exception{
        ReturnResult result=new ReturnResult();
        Integer parentId=0;
        String id=request.getParameter("id");
    ...
    public String deleteProductCategory(HttpServletRequest request,HttpServletResponse response)throws Exception{
        ReturnResult result=new ReturnResult();
        //获取分类id
        String id=request.getParameter("id");
        String type=request.getParameter("type");

    ...
    <!--Begin 所在收货地区 Begin-->
        ...
        <span class="fr">
          <c:if test="${sessionScope.loginUser==null}">
            <span class="fl">你好，请<a href="${ctx}/toLogin"  style="color:#ff4e00;">登录</a>&nbsp;<a href="${ctx}/toRegister" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;</span>
          </c:if>
          <c:if test="${sessionScope.loginUser!=null}">
            <span class="fl"><a href="${ctx}/admin/user/index">${sessionScope.loginUser.userName}</a>&nbsp;|&nbsp;<a href="${ctx}/admin/order/index?userId=${sessionScope.loginUser.id}">我的订单</a>&nbsp;</span>
          </c:if>
